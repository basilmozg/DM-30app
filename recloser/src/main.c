...
static int32_t half_phase[8], full_phase[8], direct[8];
...
static uint32_t RMS[8];
static uint32_t SUB_ZERO_RMS[8], ABOVE_ZERO_RMS[8];
...
void CURRENT_PHASE_EVENT(int16_t ADC_val, uint8_t channel)
{
    ...
    int16_t VAL = (ADC_val - modbus_reg_03[mod_reg_03_cal_adc_0_chan_0 + channel]);
    ...
    if((half_phase[channel] > 40 && VAL > 0 && direct[channel] == 0) || (half_phase[channel] > 60 && direct[channel] == 0))
    {
        direct[channel] = 1; 
        ABOVE_ZERO_RMS[channel] = RMS[channel] / half_phase[channel];
...
/*!!!*/     //modbus_reg_03[mod_reg_03_cal_adc_0_chan_0 + channel] = zero_val_final[channel];
            zero_val[channel] = 0;
            zero_val_counter[channel] = 0;
        }
        MTZ(ABOVE_ZERO_RMS[channel], channel);
        //MTZ(TEST_SUB_ZERO_RMS[channel], channel);
        if(channel < 3) 
        {
            switch (channel)
            {
        ...
        max_val[channel] = 0; min_val[channel] = 32767; half_phase[channel] = 0; RMS[channel] = 0; full_phase[channel] = 0;
    }
    if((half_phase[channel] > 40 && VAL <= 0 && direct[channel] == 1) || (half_phase[channel] > 60 && direct[channel] == 1)) 
    {
        direct[channel] = 0;
        SUB_ZERO_RMS[channel] = RMS[channel] / half_phase[channel];
...
void TAG_read_1()
{
    modbus_reg_04[mod_reg_04_current_A]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_0], CURRENT[mod_reg_04_current_A],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_0]);
    modbus_reg_04[mod_reg_04_current_B]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_1], CURRENT[mod_reg_04_current_B],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_1]);
    modbus_reg_04[mod_reg_04_current_C]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_2], CURRENT[mod_reg_04_current_C],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_2]);
    modbus_reg_04[mod_reg_04_current_3I0] = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_3], CURRENT[mod_reg_04_current_3I0], modbus_reg_03[mod_reg_03_cal_adc_100_chan_3]);
    modbus_reg_04[mod_reg_04_voltage_A]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_4], CURRENT[mod_reg_04_voltage_A],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_4]);
    modbus_reg_04[mod_reg_04_voltage_B]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_5], CURRENT[mod_reg_04_voltage_B],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_5]);
    modbus_reg_04[mod_reg_04_voltage_C]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_6], CURRENT[mod_reg_04_voltage_C],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_6]);
    modbus_reg_04[mod_reg_04_voltage_x]   = SCALE_RECALC(modbus_reg_03[mod_reg_03_cal_scale_100_chan_7], CURRENT[mod_reg_04_voltage_x],   modbus_reg_03[mod_reg_03_cal_adc_100_chan_7]);
}
...
void adc_calibration_handler()
{
    if(modbus_reg_03[mod_reg_03_calibr_command] != 0)
    {
        for(uint8_t i = 0; i < 8; i++)
        {
            ...
            {
                modbus_reg_03[mod_reg_03_cal_adc_100_chan_0 + i] = CURRENT[i];
                bitSet(modbus_reg_03[mod_reg_03_calibration_done], i + 8);
                modbus_reg_04[mod_reg_04_calibration_alarm] = modbus_reg_03[mod_reg_03_calibration_done];
            }
            if(readBit(modbus_reg_03[mod_reg_03_calibr_command], i) == 1)
            {
...
void main(void)
{
    ...
    LOG_INF_GLOB("Last register number %d", mod_reg_03_crc);
