...
#define saadc_sampling_rate                       300
#define period_counts_1                           (10000 / saadc_sampling_rate) - 10
#define period_counts_2                           ((10000 / saadc_sampling_rate) * 2 - 10)
//#define MANUAL_ADC
...
#define LOG_INF_GLOB(...) NULL//(__VA_ARGS__)
#define LOG_WRN_GLOB(...) NULL//(__VA_ARGS__)
